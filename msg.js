const { default: makeWASocket, useMultiFileAuthState, delay, makeCacheableSignalKeyStore, Browsers, jidNormalizedUser, proto, downloadContentFromMessage, getContentType } = require('queenruva-sockets');
const fs = require('fs')
